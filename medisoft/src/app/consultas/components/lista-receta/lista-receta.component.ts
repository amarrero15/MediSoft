...
@Component({
  ...
  styleUrls: ['./lista-receta.component.scss']
})
export class ListaRecetaComponent implements AfterViewInit {
  displayedColumns: string[] = ['medicamento', 'cantidad', 'dosis', 'editar', 'eliminar'];
